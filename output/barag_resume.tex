...
\marginsection{Experience}\relax
    ...
    \begin{job}{Drexel University Capstone Project}
        ...
        {job_6}
            \begin{itemize*}
                ...
                \item Implementd data persistence on SD card via SPI via vendor library
    ...
    \begin{tikzpicture}[overlay, transform canvas={xshift=-0.5ex}]
        ...
        \node [bubble] at (job_8) (job_8_bubble) {};
        \node [align=right, text width=3cm, base left=2ex of job_8_bubble.base]
            at (job_8)
            (job_8_label)
