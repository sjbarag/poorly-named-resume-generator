...
\section{Experience}\relax
    ...
    \begin{tikzpicture}[overlay, transform canvas={xshift=-0.5ex}]
        \node [bubble, label=left:2015-04-02 -- Present] at (job_0) (job_0_bubble) {};
        \node [bubble, label=left:2013-08-12 -- 2015-04-02] at (job_1) (job_1_bubble) {};
        \node [bubble, label=left:2012-04-01 -- 2012-09-01] at (job_2) (job_2_bubble) {};
        \node [bubble, label=left:2011-03-01 -- 2011-09-01] at (job_3) (job_3_bubble) {};
    \draw
        (job_0_bubble) --
        (job_1_bubble) --
        (job_2_bubble) --
